    ...
    if (loading && announcements.length === 0) {
      const dummyAnnouncements: Announcement[] = [
        ...
        },
        {
          ...
          content: 'We\'ve updated our tier points system for better team balancing. Check the FAQ for details.',
          date: new Date(Date.now() - 7 * 24 * 60 * 60 * 1000).toISOString(),
        },
        {
          id: '3',
          title: 'Discord Server Upgrade',
          content: 'Our Discord server has been upgraded with new features! Join us for voice channels, role assignments, and more.',
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {announcements.map((announcement) => (
              ...
              >
                ...
                <div className="text-gray-300 mb-4 line-clamp-4">
